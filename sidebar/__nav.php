    ...
    <div class="p-0 sidebar-wrap transition">
        ...
        <div class="card border-0 sidebar">
            ...
            <div class="links">
                ...
                <a href="/thewheelphp/member/data_list2FOR0408.php" class="d-flex align-items-center transition"><i class="material-icons">group</i></svg>會員管理</a>
                <a href="/thewheelphp/course/data_list.php" class="d-flex align-items-center transition"><i class="material-icons">school</i>課程管理</a>
                <a href="/thewheelphp/program/event_list.php" class="d-flex align-items-center transition"><i class="material-icons">today</i>活動管理</a>
                <a href="/thewheelphp/route/display.php" class="d-flex align-items-center transition"><i class="material-icons">place</i>路線管理</a>
                <a href="/thewheelphp/product/p_data_list2.php" class="d-flex align-items-center transition"><i class="material-icons">playlist_add</i>商品管理</a>
                <a href="/thewheelphp/post/listtest.php" class="d-flex align-items-center transition"><i class="material-icons">edit</i>文章管理</a>
            </div>
